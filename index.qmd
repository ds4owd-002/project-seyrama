...
processed_data |> 
  ...
  summarise(
    ...
    prop_toilet_usable = round(mean(toilet_usable == "Yes", na.rm = TRUE), 0),
    prop_water_avail = round(mean(water_supply_main_avl == "Yes", na.rm = TRUE), 0)
  )

processed_data <- processed_data |> mutate(basic_wash = if_else(water_supply_main_avl == "Yes" &
                                toilet_usable == "Yes" &
